...
export default function CategoryItem(category,showDetaiCategory) {
    ...
    return (
        ...
        <tr >
            ...
            <td>{category.category.supplierId}</td>
            <td><button onClick={toggle} className="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
        ...
        <ModalBody>
          <Card>
              <CardText>Bạn có chắc chắn muốn xóa {category.category.categoryName}</CardText>
          </Card>
        </ModalBody>
        <ModalFooter>
