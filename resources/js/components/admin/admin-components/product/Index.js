        ...
        return (
            <>
                ...
                <Modal isOpen={this.state.value}  >
                            ...
                            <Form>
                                ...
                                <InputGroup>
                                    <InputGroupAddon addonType="append">
                                        <Label className="label-insert-admin">Hình Ảnh</Label>
                                    </InputGroupAddon>
                                ...
                                <InputGroup>
                                    <InputGroupAddon addonType="append">
                                        <Label className="label-insert-admin">Danh Mục Sản Phẩm</Label>
                                    </InputGroupAddon>
                                    <Input onChange={(e) => this.handleChangeCategoryId(e)} />
                                </InputGroup>

                                <InputGroup>
                                    <InputGroupAddon addonType="append">
                                        <Label className="label-insert-admin">Tên Sản Phẩm</Label>
                                    </InputGroupAddon>
                                ...
                                <InputGroup>
                                    <InputGroupAddon addonType="append">
                                        <Label className="label-insert-admin">Giá Cả</Label>
                                    </InputGroupAddon>
                                    <Input type="number" onChange={(e) => this.handleChangePrice(e)} />
                                </InputGroup>

                                <InputGroup>
                                    <InputGroupAddon addonType="append">
                                        <Label className="label-insert-admin">Số Lượng Nhập</Label>
                                    </InputGroupAddon>
                                ...
                                <InputGroup>
                                    <InputGroupAddon addonType="append">
                                        <Label className="label-insert-admin">Màu</Label>
                                    </InputGroupAddon>
                                    <Input onChange={(e) => this.handleChangeColor(e)} />
                                </InputGroup>

                                <InputGroup>
                                    <InputGroupAddon addonType="append">
                                        <Label className="label-insert-admin">Mô tả </Label>
                                    </InputGroupAddon>
                                    <Input onChange={(e) => this.handleChangeDescription(e)} />
                                </InputGroup>
                    ...
                    <ModalFooter>
                        <Button color="secondary" onClick={() => this.handleClick(this.state.value)}>Close</Button>
                        <Button color="primary" onClick={() => this.addProduct()}>Thêm</Button>
                    </ModalFooter>
                </Modal>
            </>
